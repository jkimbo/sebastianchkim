...
function quidus_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Kirki - Advanced Wordpress Customizer', // The plugin name.
            'slug'               => 'Kirki', // The plugin slug (typically the folder name).
            'source'             => 'https://downloads.wordpress.org/plugin/kirki.0.8.4.zip', // The plugin source.
	...
	$config = array(
		...
		'strings'      		=> array(
			...
			'notice_can_install_required'     			=> _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'quidus' ), // %1$s = plugin name(s)
			'notice_can_install_recommended'			=> _n_noop( 'This theme comes packaged with the following premium plugin: %1$s. enjoy:)', 'This theme comes packaged with the following premium plugin: %1$s. enjoy:)', 'quidus' ), // %1$s = plugin name(s)
			...
			'notice_can_activate_required'    			=> _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'quidus' ), // %1$s = plugin name(s)
